...
urlpatterns = [
    ...
    path('user/userdashboard/', views.userdashboard, name='userdashboard'),
    ...
    path('scan/predict/', views.predict_image, name='predict_image'),
    ...
    # ===== API ENDPOINTS =====
    path('api/users/', views.admin_get_users_api, name='get_users_api'),
    ...
    path('api/guest/scan/', views.guest_scan_diagnose, name='guest_scan_image'),
    path('api/guest/limits/', views.get_daily_scan_limits, name='get_guest_scan_limits'),

    #Guest
     # Guest Dashboard URLs
    path('guest-dashboard/', views.guest_dashboard, name='guest_dashboard'),
    path('guest-scan-image/', views.guest_scan_image, name='guest_scan_image'),
    ...
    path('scan-diagnose/', views.scan_diagnose_view, name='scan_diagnose'),
    path('scan-image/', views.scan_image, name='scan_image'),
    path('scan-history/', views.scan_history, name='scan_history'),
    path('delete-scan/<str:scan_id>/', views.delete_scan, name='delete_user_scan'),
   ...
   # User Profile URLs
    ...
    path('users/list/', views.admin_user_list, name='admin_user_list'),
    path('users/delete/<int:user_id>/', views.delete_user, name='delete_user'),
    path('admin/users/list', views.admin_user_list, name='admin_user_list'),
    path('admin/dashboard-api/', views.dashboard_api, name='dashboard_api'),
    ...
    # E-commerce URLs
    path('ecommerce/', views.admin_ecommerce, name='admin_ecommerce'),
    path('pending-orders/', views.admin_pending_orders, name='admin_pending_orders'),
    path('order-detail/<str:order_id>/', views.admin_order_detail, name='admin_order_detail'),
    path('reports/', views.admin_reports, name='admin_reports'),
    path('print-report/', views.print_monthly_report, name='admin_print_monthly_report'),
    
    # Order management
    path('update-order-status/<str:order_id>/', views.update_order_status, name='update_order_status'),

  # Image analysis functionality
    path('admin/image-analysis/', views.image_analysis_dashboard, name='image_analysis_dashboard'),
